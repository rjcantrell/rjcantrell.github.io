!(function () {
  ...
  common.tooltip = function () {
    var tip = d3.select('.' + common.tooltip_class).data([1])
  ...
  common.linechart_mouseover = function (ContainerID, produceHtmlFromD) {
    var tipID = 'tip_for_' + ContainerID
    var tooltip = common.tooltip(tipID)
    d3.selectAll('#' + ContainerID + ' circle')
